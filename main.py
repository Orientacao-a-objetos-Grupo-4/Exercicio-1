...
Turma1.add_aluno(Aluno1, Curso1)
Turma1.add_aluno(Aluno2, Curso1)
Turma2.add_aluno(Aluno1, Curso1)
Turma2.add_aluno(Aluno3, Curso1)
Turma3.add_aluno(Aluno2, Curso1)
Turma3.add_aluno(Aluno4, Curso1)
...
Turma1.retorno_rem_aluno(Aluno1)
print("_____________________________________________________________________________________")
print("Exercício 11: Excluir uma turma de um curso")
Curso1.retorno_rem_turma(Turma1)
print("_____________________________________________________________________________________")
